...
const I18N = {
  es: {
    ...
    statProperties: "propiedades administradas",
    ...
    visionTitle: "Una empresa orientada al valor y al largo plazo",
    visionTextOne:
      "Nuestra visión es posicionar a Meirah Group como una firma inmobiliaria confiable, moderna y estratégica, capaz de acompañar tanto decisiones patrimoniales personales como oportunidades de inversión con criterio.",
    visionTextTwo:
      "Nuestra misión es ofrecer una asesoría clara, cercana y bien estructurada para que cada cliente pueda comprar, vender, alquilar o desarrollar una propiedad con seguridad, enfoque y una perspectiva real de crecimiento.",
  ...
  en: {
    ...
    visionTitle: "A firm focused on value and the long term",
    visionTextOne:
      "Our vision is to position Meirah Group as a reliable, modern, and strategic real estate firm, able to guide both personal wealth decisions and investment opportunities with sound judgment.",
    visionTextTwo:
      "Our mission is to provide clear, close, and well-structured advisory so every client can buy, sell, rent, or develop property with confidence, focus, and a real growth perspective.",
...
I18N.pt = {
  ...
  visionEyebrow: "Visão",
  visionTitle: "Uma empresa orientada ao valor e ao longo prazo",
  visionTextOne:
    "Nossa visão é posicionar a Meirah Group como uma empresa imobiliária confiável, moderna e estratégica, capaz de acompanhar tanto decisões patrimoniais pessoais quanto oportunidades de investimento com critério.",
  visionTextTwo:
    "Nossa missão é oferecer uma assessoria clara, próxima e bem estruturada para que cada cliente possa comprar, vender, alugar ou desenvolver um imóvel com segurança, foco e uma perspectiva real de crescimento.",
...
function applyPageMode() {
  ...
  const footerLinkMap = [
    ...
    [".site-footer a[href=\"#adminPanel\"]", onProperties ? "#adminPanel" : pageLink("properties", "#adminPanel")],
  ];
